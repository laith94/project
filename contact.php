...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="images/ww.png">
  ...
  <header class="header-bar d-flex d-lg-block align-items-center" data-aos="fade-left">
    ...
    <div class="main-menu">
      ...
      <ul class="social js-clone-nav">
        <li><a target="_blank"  href="https://www.facebook.com/laith.abdalamer"><span class="icon-facebook"></span></a></li>
                  ...
                  <form method="POST" action="Login.php">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        <input name="last-Name" type="text" id="lname" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="row form-group mb-5">
                      <div class="col-md-12">
                        <label class="text-white" for="Newborns">Newborns</label> <br>
